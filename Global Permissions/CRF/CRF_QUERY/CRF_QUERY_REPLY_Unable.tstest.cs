...
namespace TestProject1
{
    ...
    public class CRF_QUERY_REPLY_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CRFSDVSeriesAssigned);
        }
        ...
        [CodedStep(@"[CRF_QUERY_REPLY_CodedStep] : Navigate to assigned CRF series in SDV step")]
        public void CRF_QUERY_REPLY_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFSDVSeriesAssigned, true);
