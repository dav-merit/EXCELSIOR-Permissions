...
namespace TestProject1
{
    ...
    public class CRF_QUERY_RESOLVE_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CRFStudyURL);
        }
        ...
        [CodedStep(@"[CRF_QUERY_RESOLVE_Unable_CodedStep] : Navigate to CRF series with Answered query")]
        public void CRF_QUERY_RESOLVE_Unable_CodedStep()
        {
            // Navigate to : ''
