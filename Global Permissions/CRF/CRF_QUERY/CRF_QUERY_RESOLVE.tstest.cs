...
namespace TestProject1
{
    ...
    public class CRF_QUERY_RESOLVE : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CRFSeriesAnsweredQuery);
        ...
        public void CRF_QUERY_RESOLVE_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFSeriesAnsweredQuery, true);
            
        }
    
        [CodedStep(@"Enter password in 'PasswordInput'")]
        public void CRF_QUERY_RESOLVE_CodedStep1()
        {
            // Enter password in 'PasswordInput'
            Actions.SetText(Pages.ExcelsiorCRF2.PasswordInput, Global_Variables.PermissionsPassword);
