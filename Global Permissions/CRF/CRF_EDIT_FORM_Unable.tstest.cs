...
namespace TestProject1
{
    ...
    public class CRF_EDIT_FORM_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CRFDataEntrySeriesAssigned);
        }
        ...
        [CodedStep(@"[CRF_EDIT_FORM_CodedStep] : Navigate to assigned Data Entry series")]
        public void CRF_EDIT_FORM_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFAssignedDataEntrywithString, true);
