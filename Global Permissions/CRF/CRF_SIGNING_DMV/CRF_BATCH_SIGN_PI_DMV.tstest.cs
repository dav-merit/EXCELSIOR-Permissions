...
namespace TestProject1
{
    ...
    public class CRF_BATCH_SIGN_PI_DMV : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_BATCH_SIGN_PI_DMV_CodedStep] : Navigate to CRF Site")]
        public void CRF_BATCH_SIGN_PI_DMV_CodedStep()
        {
            // Navigate to : ''
        ...
        public void CRF_BATCH_SIGN_PI_DMV_CodedStep1()
        {
            // Enter text '' in 'PasswordInput'
            Actions.SetText(Pages.ExcelsiorSeriesFA1.PasswordInput, Global_Variables.PermissionsPassword);
