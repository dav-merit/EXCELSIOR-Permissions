...
namespace TestProject1
{
    ...
    public class CRF_BATCH_WIZARD_DMV_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CRFSubjectDashboard);
        }
        ...
        [CodedStep(@"[CRF_BATCH_WIZARD_PI_REVIEW_CodedStep] : Navigate to Subject Dashboard in CRF Study")]
        public void CRF_BATCH_WIZARD_PI_DMV_CodedStep()
        {
            // Navigate to : ''
