...
namespace TestProject1
{
    ...
    public class CRF_COMPLETE_AT_DMV : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.AssignedCRFDMVSeries);
        }
        ...
        public void CRF_COMPLETE_AT_DMV_CodedStep1()
        {
        ...
        public void CRF_COMPLETE_AT_DMV_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.AssignedCRFDMVSeries, true);
