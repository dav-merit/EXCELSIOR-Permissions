...
namespace TestProject1
{
    ...
    public class CRF_COMPLETE_AT_SDV_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CRFSDVSeriesAssignedReadyforSignoff);
        }
        ...
        [CodedStep(@"[CRF_COMPLETE_AT_SDV_CodedStep] : Navigate to SDV series ready for sign-off")]
        public void CRF_COMPLETE_AT_SDV_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFSDVSeriesAssignedReadyforSignoff, true);
