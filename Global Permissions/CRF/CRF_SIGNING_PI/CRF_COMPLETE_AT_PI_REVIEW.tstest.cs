...
namespace TestProject1
{
    ...
    public class CRF_COMPLETE_AT_PI_REVIEW : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_BATCH_SIGN_PI_REVIEW_CodedStep] : Navigate to CRF Site")]
        public void CRF_COMPLETE_AT_PI_REVIEW_CodedStep1()
        {
            // Navigate to : ''
