...
namespace TestProject1
{
    ...
    public class CRF_BATCH_WIZARD_PI_REVIEW_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.SubjectDashboard);
        }
        ...
        [CodedStep(@"[CRF_BATCH_WIZARD_PI_REVIEW_CodedStep] : Navigate to Subject Dashboard")]
        public void CRF_BATCH_WIZARD_PI_REVIEW_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFSubjectDashboard, true);
