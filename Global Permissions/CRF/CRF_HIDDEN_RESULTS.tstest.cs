...
namespace TestProject1
{
    ...
    public class CRF_HIDDEN_RESULTS : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_HIDDEN_RESULTS_CodedStep] : Navigate to CRF series with Data Issues")]
        public void CRF_HIDDEN_RESULTS_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFDataIssueSeries, true);
