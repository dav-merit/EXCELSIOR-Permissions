...
namespace TestProject1
{
    ...
    public class CRF_POOL_VIEW : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_POOL_VIEW_CodedStep] : Navigate to CRF Study")]
        public void CRF_POOL_VIEW_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFStudyURL, true);
