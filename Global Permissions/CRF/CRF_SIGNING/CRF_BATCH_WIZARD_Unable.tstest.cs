...
namespace TestProject1
{
    ...
    public class CRF_BATCH_WIZARD_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_BATCH_WIZARD_Unable_CodedStep] : Navigate to subject dashboard for a subject in a CRF study")]
        public void CRF_BATCH_WIZARD_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFSubject, true);
