...
namespace TestProject1
{
    ...
    public class CRF_FREEZE_RESULTS_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_FREEZE_RESULTS_CodedStep] : Navigate to assigned SDV series ")]
        public void CRF_FREEZE_RESULTS_Unable_CodedStep()
        {
            // Navigate to : ''
