...
namespace TestProject1
{
    ...
    public class CRF_ASSIGN_FORM_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_ASSIGN_FORM_Unable_CodedStep] : Navigate to unassigned CRF Data Entry series")]
        public void CRF_ASSIGN_FORM_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CRFDataEntrySeriesUnassigned, true);
