...
namespace TestProject1
{
    ...
    public class CRF_COMPLETE_AT_DETERMINATION_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CRF_COMPLETE_AT_DETERMINATION_Unable_CodedStep] : Navigate to assigned Data Entry series")]
        public void CRF_COMPLETE_AT_DETERMINATION_Unable_CodedStep()
        {
            // Navigate to : ''
