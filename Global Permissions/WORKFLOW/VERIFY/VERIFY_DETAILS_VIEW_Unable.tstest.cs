...
namespace TestProject1
{
    ...
    public class VERIFY_DETAILS_VIEW_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[VERIFY_DETAILS_VIEW_Unable_CodedStep] : Navigate to Grade series")]
        public void VERIFY_DETAILS_VIEW_Unable_CodedStep()
        {
            // Navigate to : ''
