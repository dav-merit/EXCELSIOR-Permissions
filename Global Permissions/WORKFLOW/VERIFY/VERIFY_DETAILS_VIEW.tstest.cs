...
namespace TestProject1
{
    ...
    public class VERIFY_DETAILS_VIEW : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[VERIFY_DETAILS_VIEW_CodedStep] : Navigate to series in Grade")]
        public void VERIFY_DETAILS_VIEW_CodedStep()
        {
            // Navigate to : ''
