...
namespace TestProject1
{
    ...
    public class VERIFY_VIEW_IMAGES_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[VERIFY_VIEW_IMAGES_Unable_CodedStep] : Navigate to series in Verify")]
        public void VERIFY_VIEW_IMAGES_Unable_CodedStep()
        {
            // Navigate to : ''
