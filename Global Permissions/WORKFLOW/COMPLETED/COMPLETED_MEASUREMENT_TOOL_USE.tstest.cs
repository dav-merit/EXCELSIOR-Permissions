...
namespace TestProject1
{
    ...
    public class COMPLETED_MEASUREMENT_TOOL_USE : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CompletedFANoMeasurements);
        }
        ...
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.CompletedFANoMeasurements, true);
