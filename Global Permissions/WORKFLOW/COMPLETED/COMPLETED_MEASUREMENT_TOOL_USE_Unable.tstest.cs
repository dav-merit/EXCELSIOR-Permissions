...
namespace TestProject1
{
    ...
    public class COMPLETED_MEASUREMENT_TOOL_USE_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[COMPLETED_MEASUREMENT_TOOL_VIEW_CodedStep] : Navigate to Completed series")]
        public void COMPLETED_MEASUREMENT_TOOL_VIEW_CodedStep()
        {
                        // Navigate to : ''
