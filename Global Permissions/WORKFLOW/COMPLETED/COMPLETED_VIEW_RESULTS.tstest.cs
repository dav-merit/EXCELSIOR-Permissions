...
namespace TestProject1
{
    ...
    public class COMPLETED_VIEW_RESULTS : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Navigate to Completed series")]
        public void COMPLETED_VIEW_RESULTS_CodedStep()
        {
            // Navigate to Completed series
