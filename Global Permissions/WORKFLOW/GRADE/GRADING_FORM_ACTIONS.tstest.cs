...
namespace TestProject1
{
    ...
    public class GRADING_FORM_ACTIONS : BaseWebAiiTest
    {
        ...
        public void GRADING_FORM_ACTIONS_CodedStep()
        {
            // Navigate to : ''
        ...
        [CodedStep(@"Enter text 'Password' in 'GradingFormActivateInactivatePW'")]
        public void GRADING_FORM_ACTIONS_CodedStep2()
        {
            // Enter text 'Password' in 'GradingFormActivateInactivatePW'
            Actions.SetText(Pages.ExcelsiorSeriesFA13.GradingFormActivateInactivatePW, Global_Variables.PermissionsPassword);
