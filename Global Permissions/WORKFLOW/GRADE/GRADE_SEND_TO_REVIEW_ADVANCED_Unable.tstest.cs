...
namespace TestProject1
{
    ...
    public class GRADE_SEND_TO_REVIEW_ADVANCED_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.SimultaneousGradeSeries);
        }
        ...
        [CodedStep(@"[GRADE_SEND_TO_REVIEW_Unable_CodedStep] : Navigate to Grade series with scheduled Verify step")]
        public void GRADE_SEND_TO_REVIEW_ADVANCED_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.SimultaneousGradeSeries, true);
