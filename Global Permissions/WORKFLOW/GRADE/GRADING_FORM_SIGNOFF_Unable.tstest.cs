...
namespace TestProject1
{
    ...
    public class GRADING_FORM_SIGNOFF_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.AssignedGradeSeriesReadytoSign);
        }
        ...
        [CodedStep(@"[GRADING_FORM_SIGNOFF_Unable_CodedStep] : Navigate to assigned Grade series ready for signoff")]
        public void GRADING_FORM_SIGNOFF_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.AssignedGradeSeriesReadytoSign, true);
