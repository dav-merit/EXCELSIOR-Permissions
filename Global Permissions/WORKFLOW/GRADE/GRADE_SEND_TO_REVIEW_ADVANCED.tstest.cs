...
namespace TestProject1
{
    ...
    public class GRADE_SEND_TO_REVIEW_ADVANCED : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[GRADE_SEND_TO_REVIEW_CodedStep] : Navigate to Grade series with scheduled Verify step")]
        public void GRADE_SEND_TO_REVIEW_ADVANCED_CodedStep()
        {
            // Navigate to : ''
