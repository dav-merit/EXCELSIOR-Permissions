...
namespace TestProject1
{
    ...
    public class GRADE_AUDIT_TRAIL : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[GRADE_AUDIT_TRAIL_CodedStep] : Navigate to series in Grade")]
        public void GRADE_AUDIT_TRAIL_CodedStep()
        {
                        // Navigate to : ''
                        ActiveBrowser.NavigateTo(Global_Variables.GradeSeries, true);
                        
        }
    
        [CodedStep(@"[GRADE_AUDIT_TRAIL_CodedStep1] : Navigate to series in Verify")]
        public void GRADE_AUDIT_TRAIL_CodedStep1()
        {
                        // Navigate to : ''
                        ActiveBrowser.NavigateTo(Global_Variables.VerifySeries, true);
