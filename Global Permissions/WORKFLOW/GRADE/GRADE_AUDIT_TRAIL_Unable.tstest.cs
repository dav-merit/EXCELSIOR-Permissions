...
namespace TestProject1
{
    ...
    public class GRADE_AUDIT_TRAIL_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GradeSeries);
            Log.WriteLine(Global_Variables.VerifySeries);
        }
        ...
        public void GRADE_AUDIT_TRAIL_Unable_CodedStep()
        {
            // Navigate to : ''
        ...
        [CodedStep(@"Navigate to : ''")]
        public void GRADE_AUDIT_TRAIL_Unable_CodedStep1()
        {
            // Navigate to : ''
