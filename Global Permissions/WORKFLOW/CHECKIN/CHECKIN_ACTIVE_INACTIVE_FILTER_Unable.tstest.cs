...
namespace TestProject1
{
    ...
    public class CHECKIN_ACTIVE_INACTIVE_FILTER_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CHECKIN_SUBMIT_OVERRIDE_Unable_CodedStep] : Navigate to series in Checkin")]
        public void CHECKIN_SUBMIT_OVERRIDE_Unable_CodedStep()
        {
                        // Navigate to : ''
