...
namespace TestProject1
{
    ...
    public class CHECKIN_CANCEL_PROCESSING_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CHECKIN_CANCEL_PROCESSING_Unable_CodedStep] : Navigate to check-in series")]
        public void CHECKIN_CANCEL_PROCESSING_Unable_CodedStep()
        {
            // Navigate to : ''
