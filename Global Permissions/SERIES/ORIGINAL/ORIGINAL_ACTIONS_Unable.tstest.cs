...
namespace TestProject1
{
    ...
    public class ORIGINAL_ACTIONS_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[ORIGINAL_ACTIONS_CodedStep] : Navigate to series in Upload with files")]
        public void ORIGINAL_ACTIONS_Unable_CodedStep()
        {
            // Navigate to : ''
