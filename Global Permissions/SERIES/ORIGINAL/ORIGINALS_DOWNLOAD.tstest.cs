...
namespace TestProject1
{
    ...
    public class ORIGINALS_DOWNLOAD : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[ORIGINALS_DOWNLOAD_Unable_CodedStep] : Navigate to Upload series with files")]
        public void ORIGINALS_DOWNLOAD_Unable_CodedStep()
        {
            // Navigate to : ''
