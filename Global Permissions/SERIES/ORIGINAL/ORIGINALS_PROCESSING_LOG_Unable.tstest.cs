...
namespace TestProject1
{
    ...
    public class ORIGINALS_PROCESSING_LOG_Unable : BaseWebAiiTest
    {
        ...
        public void ORIGINALS_PROCESSING_LOG_Unable_CodedStep()
        {
            // Navigate to : ''
        ...
        [CodedStep(@"Navigate to : ''")]
        public void ORIGINALS_PROCESSING_LOG_Unable_CodedStep1()
        {
            // Navigate to : ''
