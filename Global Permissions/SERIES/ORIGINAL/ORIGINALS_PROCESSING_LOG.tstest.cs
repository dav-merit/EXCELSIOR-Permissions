...
namespace TestProject1
{
    ...
    public class ORIGINALS_PROCESSING_LOG : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[ORIGINALS_PROCESSING_LOG_CodedStep] : Navigate to series in Upload")]
        public void ORIGINALS_PROCESSING_LOG_CodedStep()
        {
            // Navigate to : ''
        ...
        [CodedStep(@"[ORIGINALS_PROCESSING_LOG_CodedStep1] : Navigate to series in Checkin")]
        public void ORIGINALS_PROCESSING_LOG_CodedStep1()
        {
            // Navigate to : ''
