...
namespace TestProject1
{
    ...
    public class SERIES_MARK_NOT_DONE_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[SERIES_MARK_NOT_DONE_CodedStep] : Navigate to the subject dashboard for a Subject that has series to mark as Not Done")]
