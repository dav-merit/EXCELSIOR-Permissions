...
namespace TestProject1
{
    ...
    public class SERIES_GROUP_UNGROUP_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GroupIDNumber);
        }
        ...
        [CodedStep(@"[SERIES_GROUP_UNGROUP_Unable_CodedStep1] : Enter Group ID number in 'SearchInput'")]
        public void SERIES_GROUP_UNGROUP_Unable_CodedStep1()
        {
            // Enter text '' in 'SearchInput'
            Actions.SetText(Pages.ExcelsiorStudy1Sandbox6.SearchInput, Global_Variables.GroupIDNumber);
