...
namespace TestProject1
{
    ...
    public class SERIES_LOCK_ACTION_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text 'password' in 'LockPasswordInput'")]
        public void SERIES_LOCK_ACTION_CodedStep1()
        {
            // Enter text 'password' in 'LockPasswordInput'
            Actions.SetText(Pages.ExcelsiorStudy1Sandbox4.LockPasswordInput, Global_Variables.PermissionsPassword);
                        
        }
    
        [CodedStep(@"Enter text 'password' in 'LockPasswordInput'")]
        public void SERIES_LOCK_ACTION_CodedStep11()
        {
            // Enter text 'password' in 'LockPasswordInput'
            Actions.SetText(Pages.ExcelsiorStudy1Sandbox4.LockPasswordInput, Global_Variables.Password);
