...
namespace TestProject1
{
    ...
    public class SERIES_DOWNLOADS_OVERLAYS_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.SerieswithOverlay);
        }
        ...
        public void SERIES_DOWNLOAD_OVERLAYS_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.SerieswithOverlay, true);
