...
namespace TestProject1
{
    ...
    public class SERIES_DOWNLOAD_ANALYSES : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[SERIES_DOWNLOAD_VIEW_CodedStep] : Navigate to OCT series with Analysis and Layers files")]
        public void SERIES_DOWNLOAD_VIEW_CodedStep()
        {
                        // Navigate to : ''
