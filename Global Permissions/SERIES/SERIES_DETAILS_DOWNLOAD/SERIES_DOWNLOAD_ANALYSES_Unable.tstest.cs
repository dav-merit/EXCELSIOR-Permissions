...
namespace TestProject1
{
    ...
    public class SERIES_DOWNLOAD_ANALYSES_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
                        ...
                        Log.WriteLine(Global_Variables.OCTWithAnalysisandLayers);
        }
        ...
        [CodedStep(@"[SERIES_DOWNLOAD_VIEW_Unable_CodedStep] : Navigate to OCT series with Analysis and Layers files")]
        public void SERIES_DOWNLOAD_VIEW_Unable_CodedStep()
        {
                        // Navigate to : ''
                        ActiveBrowser.NavigateTo(Global_Variables.OCTWithAnalysisandLayers, true);
