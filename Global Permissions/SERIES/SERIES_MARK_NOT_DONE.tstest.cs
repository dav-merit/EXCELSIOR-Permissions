...
namespace TestProject1
{
    ...
    public class SERIES_MARK_NOT_DONE : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.SubjectNoSeries);
        }
        ...
        public void SERIES_MARK_NOT_DONE_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.SubjectNoSeries, true);
            
        }
    
    
        [CodedStep(@"Enter text 'Te' in 'MatInput3Password'")]
        public void SERIES_MARK_NOT_DONE_CodedStep2()
        {
            // Enter text 'Te' in 'MatInput3Password'
            Actions.SetText(Pages.ExcelsiorSubject.MatInput3Password, Global_Variables.PermissionsPassword);
