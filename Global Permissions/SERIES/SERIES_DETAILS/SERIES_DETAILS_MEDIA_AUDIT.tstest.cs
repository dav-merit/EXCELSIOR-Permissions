...
namespace TestProject1
{
    ...
    public class SERIES_DETAILS_MEDIA_AUDIT : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[SERIES_DETAILS_WORKFLOW_AUDIT_CodedStep] : Navigate to series in Completed")]
        public void SERIES_DETAILS_WORKFLOW_AUDIT_CodedStep()
        {
                        // Navigate to : ''
