...
namespace TestProject1
{
    ...
    public class SERIES_DETAILS_ADD_COMMENT_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[SERIES_DETAILS_ADD_COMMENT_CodedStep] : Navigate to series in Grade")]
        public void SERIES_DETAILS_ADD_COMMENT_CodedStep()
        {
                        // Navigate to : ''
