...
namespace TestProject1
{
    ...
    public class SERIES_DETAILS_MEDIA_AUDIT_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[SERIES_DETAILS_WORKFLOW_AUDIT_Unable_CodedStep] : Navigate to series in Completed")]
        public void SERIES_DETAILS_WORKFLOW_AUDIT_Unable_CodedStep()
        {
                        // Navigate to : ''
