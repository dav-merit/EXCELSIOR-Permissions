...
namespace TestProject1
{
    ...
    public class SERIES_CHANGE_ACTIVE : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text '' in 'MatInput9Password'")]
        public void SERIES_CHANGE_ACTIVE_CodedStep1()
        {
            // Enter text '' in 'MatInput9Password'
            Actions.SetText(Pages.ExcelsiorSubject001ALEX90.MatInput9Password, Global_Variables.Password);
