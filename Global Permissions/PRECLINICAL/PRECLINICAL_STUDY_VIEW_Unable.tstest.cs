...
namespace TestProject1
{
    ...
    public class PRECLINICAL_STUDY_VIEW_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.PreclinicalStudy);
        }
        ...
        public void PRECLINICAL_STUDY_VIEW_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.PreclinicalStudy, true);
                                                
        }
    
        [CodedStep(@"Wait '5000' msec for url:''")]
        public void PRECLINICAL_STUDY_VIEW_Unable_CodedStep1()
        {
