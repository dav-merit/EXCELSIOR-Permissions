...
namespace TestProject1
{
    ...
    public class PRECLINICAL_STUDY_VIEW : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[PRECLINICAL_STUDY_VIEW_CodedStep] : Navigate to preclinical study")]
        public void PRECLINICAL_STUDY_VIEW_CodedStep()
        {
            // Navigate to : ''
        ...
        public void PRECLINICAL_STUDY_VIEW_CodedStep1()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.PreclinicalStudy, true, 5000);
