...
namespace TestProject1
{
    ...
    public class PRECLINICAL_BOOKING_VIEW : BaseWebAiiTest
    {
        ...
        public void PRECLINICAL_ACCESS_BOOKING_CodedStep()
        {
            // Navigate to : ''
        ...
        public void PRECLINICAL_ACCESS_BOOKING_CodedStep1()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.PreclinicalBookingView, true, 5000);
