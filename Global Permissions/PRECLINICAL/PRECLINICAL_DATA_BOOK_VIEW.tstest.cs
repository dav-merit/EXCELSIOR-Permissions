...
namespace TestProject1
{
    ...
    public class PRECLINICAL_DATA_BOOK_VIEW : BaseWebAiiTest
    {
        ...
        public void PRECLINICAL_SUBJECT_MATRIX_CodedStep()
        {
            // Navigate to : ''
        ...
        public void PRECLINICAL_ACCESS_BOOKING_CodedStep()
        {
            ...
            ActiveBrowser.WaitForUrl(Global_Variables.DataBookURL, true, 5000);
