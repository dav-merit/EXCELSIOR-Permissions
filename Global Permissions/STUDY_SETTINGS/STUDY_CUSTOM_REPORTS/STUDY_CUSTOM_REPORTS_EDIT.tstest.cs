...
namespace TestProject1
{
    ...
    public class STUDY_CUSTOM_REPORTS_EDIT : BaseWebAiiTest
    {
        ...
        public void STUDY_CUSTOM_REPORTS_EDIT_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.CustomReportName);
                                                
        }
    
        [CodedStep(@"Enter text 'Edit Name' in 'CustomReportNameInput'")]
        public void STUDY_CUSTOM_REPORTS_EDIT_CodedStep()
        {
            // Enter text 'Edit Name' in 'CustomReportNameInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.CustomReportNameInput, Global_Variables.CustomReportName);
