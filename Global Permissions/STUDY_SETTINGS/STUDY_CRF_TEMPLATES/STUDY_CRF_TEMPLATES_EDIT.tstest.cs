...
namespace TestProject1
{
    ...
    public class STUDY_CRF_TEMPLATES_EDIT : BaseWebAiiTest
    {
        ...
        public void GLOBAL_CRF_TEMPLATES_EDIT_Unable_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.CRFTemplateName);
