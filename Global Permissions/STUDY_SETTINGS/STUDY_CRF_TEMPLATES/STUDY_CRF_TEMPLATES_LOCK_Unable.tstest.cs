...
namespace TestProject1
{
    ...
    public class STUDY_CRF_TEMPLATES_LOCK_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CRFTemplateName);
        }
        ...
        public void STUDY_CRF_TEMPLATES_LOCK_CodedStep()
        {
            // Enter text '' in 'SearchInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.SearchInput, Global_Variables.CRFTemplateName);
