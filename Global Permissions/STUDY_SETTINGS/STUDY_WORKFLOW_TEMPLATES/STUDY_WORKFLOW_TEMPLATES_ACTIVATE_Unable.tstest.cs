...
namespace TestProject1
{
    ...
    public class STUDY_WORKFLOW_TEMPLATES_ACTIVATE_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.WFTemplateName);
        }
        ...
        [CodedStep(@"Enter text '' in 'SearchInput'")]
        public void STUDY_WORKFLOW_TEMPLATES_ACTIVATE_CodedStep()
        {
            // Enter text '' in 'SearchInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.SearchInput, Global_Variables.WFTemplateName);
