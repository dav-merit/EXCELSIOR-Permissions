...
namespace TestProject1
{
    ...
    public class STUDY_WORKFLOW_TEMPLATES_EDIT_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[STUDY_WORKFLOW_TEMPLATES_EDIT_CodedStep2] : Enter Workflow Template Name in 'GlobalSearchInput'")]
        public void STUDY_WORKFLOW_TEMPLATES_EDIT_Unable_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.WFTemplateName);
