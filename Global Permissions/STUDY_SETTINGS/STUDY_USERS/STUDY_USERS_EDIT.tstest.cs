...
namespace TestProject1
{
    ...
    public class STUDY_USERS_EDIT : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.ReadingCenterManage);
        }
        ...
        public void STUDY_USERS_EDIT_CodedStep()
        {
        ...
        public void STUDY_USERS_EDIT_CodedStep1()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.ReadingCenterManage, true);
