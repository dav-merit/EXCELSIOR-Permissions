...
namespace TestProject1
{
    ...
    public class VIEW_STUDY_TESTING_MODE_ICON_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.TestingStudyURL);
        }
        ...
        [CodedStep(@"[VIEW_STUDY_TESTING_MODE_ICON_CodedStep] : Navigate to Study with Testing Mode enabled")]
        public void VIEW_STUDY_TESTING_MODE_ICON_CodedStep()
        {
                        // Navigate to : ''
                        ActiveBrowser.NavigateTo(Global_Variables.TestingStudyURL, true);
