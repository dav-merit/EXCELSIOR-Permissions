...
namespace TestProject1
{
    ...
    public class STUDY_EQUIPMENT_MODEL_EDIT_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[STUDY_EQUIPMENT_MODEL_EDIT_CodedStep1] : Enter name of model with parameters in 'StudySearchInput'")]
        public void STUDY_EQUIPMENT_MODEL_EDIT_CodedStep1()
        {
            // Enter text 'Test' in 'StudySearchInput'
            Actions.SetText(Pages.ExcelsiorStudy1Sandbox10.StudySearchInput, Global_Variables.ModelwithParam);
