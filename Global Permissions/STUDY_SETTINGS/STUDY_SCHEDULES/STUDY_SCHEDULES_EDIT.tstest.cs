...
namespace TestProject1
{
    ...
    public class STUDY_SCHEDULES_EDIT : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text 'test' in 'GlobalReasonTextArea'")]
        public void Helper_EnterReason_CodedStep()
        {
            // Enter text 'test' in 'GlobalReasonTextArea'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalReasonTextArea, "Test Lock");
                        
        }
    
        [CodedStep(@"Enter password in 'GlobalPasswordInput'")]
        public void STUDY_SCHEDULES_EDIT_CodedStep()
        {
            // Enter password in 'GlobalPasswordInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalPasswordInput, Global_Variables.PermissionsPassword);
