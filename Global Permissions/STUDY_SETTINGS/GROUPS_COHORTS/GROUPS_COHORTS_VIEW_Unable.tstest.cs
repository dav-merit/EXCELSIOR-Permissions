...
namespace TestProject1
{
    ...
    public class GROUPS_COHORTS_VIEW_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[GROUPS_COHORTS_VIEW_Unable_CodedStep] : Navigate to study manage for a Preclinical study")]
        public void GROUPS_COHORTS_VIEW_Unable_CodedStep()
        {
            // Navigate to : ''
