...
namespace TestProject1
{
    ...
    public class STUDY_DETAILS_EDIT : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text 'password' in 'LockStudyPasswordInput'")]
        public void STUDY_DETAILS_EDIT_CodedStep()
        {
            // Enter text 'password' in 'LockStudyPasswordInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.LockStudyPasswordInput, Global_Variables.PermissionsPassword);
