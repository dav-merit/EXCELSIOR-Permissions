...
namespace TestProject1
{
    ...
    public class STUDY_RULE_TEMPLATES_ACTIVATE : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.WFRuleName);
        }
        ...
        public void STUDY_RULE_TEMPLATES_LOCK_CodedStep1()
        {
            // Enter text '' in 'SearchInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.SearchInput, Global_Variables.WFRuleName);
