...
namespace TestProject1
{
    ...
    public class STUDY_TRANSFER_ENDPOINTS_EDIT_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.EndpointNames);
        }
        ...
        [CodedStep(@"Enter Endpoint Name in 'SearchInput'")]
        public void STUDY_TRANSFER_ENDPOINTS_EDIT_CodedStep()
        {
            // Enter Endpoint Name in 'SearchInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.SearchInput, Global_Variables.EndpointNames);
