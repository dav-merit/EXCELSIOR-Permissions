...
namespace TestProject1
{
    ...
    public class STUDY_GRADING_TEMPLATES_EDIT : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GradingTemplateNameCDISC);
        }
        ...
        public void STUDY_GRADING_TEMPLATES_EDIT_CodedStep()
        {
            // Enter text 'Test' in 'SearchInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement1.SearchInput, Global_Variables.GradingTemplateNameCDISC);
