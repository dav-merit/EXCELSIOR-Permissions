...
namespace TestProject1
{
    ...
    public class GLOBAL_EQUIPMENT_MODELS_EDIT_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.ModelwithParam);
        }
        ...
        public void GLOBAL_EQUIPMENT_MODELS_EDIT_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.ModelwithParam);
