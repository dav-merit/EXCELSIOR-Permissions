...
namespace TestProject1
{
    ...
    public class GLOBAL_USER_ROLES_VIEW : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GlobalPermissions);
            Log.WriteLine(Global_Variables.StudyPermissions);
        }
        ...
        public void GLOBAL_USER_ROLES_VIEW_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.GlobalPermissions, true, 5000);
            
        }
    
        [CodedStep(@"Wait '5000' msec for url:''")]
        public void GLOBAL_USER_ROLES_VIEW_CodedStep1()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.StudyPermissions, true, 5000);
