...
namespace TestProject1
{
    ...
    public class GLOBAL_EQUIPMENT_EDIT : BaseWebAiiTest
    {
        ...
        public void GLOBAL_EQUIPMENT_EDIT_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.GlobalEquipSerial);
                                                
        }
    
        [CodedStep(@"Enter password in 'GlobalPasswordInput'")]
        public void GLOBAL_EQUIPMENT_EDIT_CodedStep()
        {
