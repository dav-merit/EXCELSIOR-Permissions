...
namespace TestProject1
{
    ...
    public class GLOBAL_EXPORT_TYPES_ACTIONS_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.ExportTypeName);
        }
        ...
        [CodedStep(@"[GLOBAL_EXPORT_TYPES_ACTIONS_Unable_CodedStep1] : Enter Export Type name in 'Export'")]
        public void GLOBAL_EXPORT_TYPES_ACTIONS_Unable_CodedStep1()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement8.GlobalSearchInput, Global_Variables.ExportTypeName);
                        
        }
    
        [CodedStep(@"Keyboard (KeyPress) - Enter (1 times) on 'GlobalSearchInput'")]
        public void GLOBAL_EXPORT_TYPES_ACTIONS_Unable_CodedStep()
        {
            ActiveBrowser.ContentWindow.SetFocus();
            Pages.ExcelsiorGlobalManagement8.GlobalSearchInput.ScrollToVisible();
            Pages.ExcelsiorGlobalManagement8.GlobalSearchInput.Focus();
