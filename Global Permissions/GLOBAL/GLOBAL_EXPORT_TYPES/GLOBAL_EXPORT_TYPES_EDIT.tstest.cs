...
namespace TestProject1
{
    ...
    public class GLOBAL_EXPORT_TYPES_EDIT : BaseWebAiiTest
    {
        ...
        public void GLOBAL_USERS_EDIT_Unable_CodedStep2()
        {
            ...
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.ExportTypeName);
