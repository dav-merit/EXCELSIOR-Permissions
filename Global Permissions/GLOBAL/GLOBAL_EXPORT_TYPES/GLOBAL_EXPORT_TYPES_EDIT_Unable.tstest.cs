...
namespace TestProject1
{
    ...
    public class GLOBAL_EXPORT_TYPES_EDIT_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[GLOBAL_EXPORT_TYPES_ACTIONS_CodedStep1] : Enter Export Type name in 'GlobalSearchInput'")]
        public void GLOBAL_EXPORT_TYPES_ACTIONS_CodedStep1()
        {
