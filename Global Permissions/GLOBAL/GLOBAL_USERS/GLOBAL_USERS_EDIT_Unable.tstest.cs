...
namespace TestProject1
{
    ...
    public class GLOBAL_USERS_EDIT_Unable : BaseWebAiiTest
    {
        ...
        public void GLOBAL_USERS_EDIT_Unable_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.GlobalUsers, true, 5000);
