...
namespace TestProject1
{
    ...
    public class GLOBAL_ANNOUNCEMENTS_ACTIONS : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.AnnouncementName);
        }
        ...
        public void GLOBAL_USERS_EDIT_Unable_CodedStep2()
        {
            ...
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.AnnouncementName);
