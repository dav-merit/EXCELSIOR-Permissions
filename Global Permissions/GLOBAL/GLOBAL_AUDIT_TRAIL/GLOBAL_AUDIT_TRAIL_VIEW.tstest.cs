...
namespace TestProject1
{
    ...
    public class GLOBAL_AUDIT_TRAIL_VIEW : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GlobalAuditTrail);
        }
        ...
        public void GLOBAL_AUDIT_TRAIL_VIEW_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.GlobalAuditTrail, true, 5000);
