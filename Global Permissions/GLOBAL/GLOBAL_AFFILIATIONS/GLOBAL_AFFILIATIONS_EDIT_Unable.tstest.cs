...
namespace TestProject1
{
    ...
    public class GLOBAL_AFFILIATIONS_EDIT_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[GLOBAL_AFFILIATIONS_EDIT_Unable_CodedStep2] : Enter Affiliation name in 'GlobalSearchInput'")]
        public void GLOBAL_AFFILIATIONS_EDIT_Unable_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.AffiliationName);
