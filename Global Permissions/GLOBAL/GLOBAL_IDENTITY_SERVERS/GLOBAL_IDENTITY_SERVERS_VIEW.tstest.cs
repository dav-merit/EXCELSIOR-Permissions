...
namespace TestProject1
{
    ...
    public class GLOBAL_IDENTITY_SERVERS_VIEW : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GlobalIdentityServer);
        }
        ...
        public void GLOBAL_IDENTITY_SERVERS_VIEW_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.GlobalIdentityServer, true, 5000);
