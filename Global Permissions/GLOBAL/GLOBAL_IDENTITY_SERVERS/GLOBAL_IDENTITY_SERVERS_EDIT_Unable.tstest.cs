...
namespace TestProject1
{
    ...
    public class GLOBAL_IDENTITY_SERVERS_EDIT_Unable : BaseWebAiiTest
    {
        ...
        public void GLOBAL_IDENTITY_SERVERS_EDIT_Unable_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.IdentityServerName);
