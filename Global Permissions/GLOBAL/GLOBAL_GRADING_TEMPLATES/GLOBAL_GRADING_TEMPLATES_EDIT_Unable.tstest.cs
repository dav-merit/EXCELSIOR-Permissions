...
namespace TestProject1
{
    ...
    public class GLOBAL_GRADING_TEMPLATES_EDIT_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GlobalGradingTemplate);
        }
        ...
        public void GLOBAL_GRADING_TEMPLATES_VIEW_CodedStep1()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.GlobalGradingTemplate);
