...
namespace TestProject1
{
    ...
    public class GLOBAL_PROCEDURES_EDIT_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GlobalProcedure);
        }
        ...
        public void GLOBAL_PROCEDURES_EDIT_Unable_CodedStep2()
        {
            // Enter text '' in 'GlobalSearchInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.GlobalProcedure);
