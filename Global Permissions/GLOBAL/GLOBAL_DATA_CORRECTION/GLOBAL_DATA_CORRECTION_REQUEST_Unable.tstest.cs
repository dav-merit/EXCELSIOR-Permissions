...
namespace TestProject1
{
    ...
    public class GLOBAL_DATA_CORRECTION_REQUEST_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.SerieswithComment);
        }
        ...
        public void GLOBAL_DATA_CORRECTION_REQUEST_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.SerieswithComment, true);
