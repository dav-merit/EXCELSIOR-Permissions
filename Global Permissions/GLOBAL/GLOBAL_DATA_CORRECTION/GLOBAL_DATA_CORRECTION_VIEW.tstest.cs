...
namespace TestProject1
{
    ...
    public class GLOBAL_DATA_CORRECTION_VIEW : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.GlobalDataCorrection);
        }
        ...
        public void GLOBAL_DATA_CORRECTION_VIEW_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.GlobalDataCorrection, true, 5000);
