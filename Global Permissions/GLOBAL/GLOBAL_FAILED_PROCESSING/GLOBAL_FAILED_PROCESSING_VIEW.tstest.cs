...
namespace TestProject1
{
    ...
    public class GLOBAL_FAILED_PROCESSING_VIEW : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.FailedProcessing);
        }
        ...
        public void GLOBAL_FAILED_PROCESSING_VIEW_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.FailedProcessing, true, 5000);
