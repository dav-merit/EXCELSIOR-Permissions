...
namespace TestProject1
{
    ...
    public class SITE_PROCEDURES_MANAGE_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.NewSiteURL);
        }
        ...
        [CodedStep(@"[SITE_PROCEDURES_MANAGE_Unable_CodedStep] : Navigate to Site Config")]
        public void SITE_PROCEDURES_MANAGE_Unable_CodedStep1()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.NewSiteURL, true);
