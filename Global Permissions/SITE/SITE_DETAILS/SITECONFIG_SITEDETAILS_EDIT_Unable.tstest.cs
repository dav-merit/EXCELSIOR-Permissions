...
namespace TestProject1
{
    ...
    public class SITECONFIG_SITEDETAILS_EDIT_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[SITECONFIG_SITEDETAILS_EDIT_CodedStep] : Navigate to site configuration for a site")]
        public void SITECONFIG_SITEDETAILS_EDIT_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.SiteConfigURL, true);
