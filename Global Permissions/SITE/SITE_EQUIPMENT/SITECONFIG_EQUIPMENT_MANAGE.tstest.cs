...
namespace TestProject1
{
    ...
    public class SITECONFIG_EQUIPMENT_MANAGE : BaseWebAiiTest
    {
        ...
        public void SITECONFIG_EQUIPMENT_MANAGE_CodedStep2()
        {
            ...
            Actions.SetText(Pages.ExcelsiorGlobalManagement3.GlobalSearchInput, Global_Variables.EquipmentNoProcedures);
