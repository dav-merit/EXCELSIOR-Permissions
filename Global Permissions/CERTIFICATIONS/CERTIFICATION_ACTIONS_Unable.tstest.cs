...
namespace TestProject1
{
    ...
    public class CERTIFICATION_ACTIONS_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CERTIFICATION_ACTIONS_CodedStep1] : Navigate to unassigned  certification item")]
        ...
        [CodedStep(@"[CERTIFICATION_ACTIONS_CodedStep2] : Navigate to certified equipment certification")]
        ...
        [CodedStep(@"[CERTIFICATION_ACTIONS_CodedStep3] : Navigate to certified technician certification")]
        ...
        [CodedStep(@"[CERTIFICATION_ACTIONS_CodedStep4] : Navigate to pending equipment certification")]
        ...
        [CodedStep(@"[CERTIFICATION_ACTIONS_CodedStep5] : Navigate to pending technician certification")]
