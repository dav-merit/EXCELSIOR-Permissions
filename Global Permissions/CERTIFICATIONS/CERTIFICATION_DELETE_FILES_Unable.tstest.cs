...
namespace TestProject1
{
    ...
    public class CERTIFICATION_DELETE_FILES_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CERTIFICATION_DELETE_FILES_CodedStep] : Navigate to pending technician certification with multiple inactive files")]
        public void CERTIFICATION_DELETE_FILES_Unable_CodedStep()
        {
            // Navigate to : ''
