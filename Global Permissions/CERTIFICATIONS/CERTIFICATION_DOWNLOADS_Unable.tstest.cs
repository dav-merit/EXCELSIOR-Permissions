...
namespace TestProject1
{
    ...
    public class CERTIFICATION_DOWNLOADS_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.EquipmentCert);
        }
        ...
        [CodedStep(@"[CERTIFICATION_DOWNLOADS_Unable_CodedStep] : Navigate to certification with files")]
        public void CERTIFICATION_DOWNLOADS_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.EquipmentCert, true);
