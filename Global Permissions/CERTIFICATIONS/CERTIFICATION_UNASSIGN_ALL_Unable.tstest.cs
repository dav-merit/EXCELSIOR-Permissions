...
namespace TestProject1
{
    ...
    public class CERTIFICATION_UNASSIGN_ALL_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text 'Skill' in 'StudySearchInput'")]
        public void CERTIFICATION_UNASSIGN_ALL_Unable_CodedStep()
        {
            // Enter text 'Skill' in 'StudySearchInput'
            Actions.SetText(Pages.ExcelsiorStudy1Sandbox10.StudySearchInput, "Grand"); //Search text should be a user name that does not bring up cert items assigned to valtestadmin
