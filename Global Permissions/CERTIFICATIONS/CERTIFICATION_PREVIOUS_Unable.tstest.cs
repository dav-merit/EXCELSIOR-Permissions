...
namespace TestProject1
{
    ...
    public class CERTIFICATION_PREVIOUS_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CERTIFICATION_PREVIOUS_CodedStep] : Navigate to completed certification")]
        public void CERTIFICATION_PREVIOUS_CodedStep()
        {
            // Navigate to : ''
