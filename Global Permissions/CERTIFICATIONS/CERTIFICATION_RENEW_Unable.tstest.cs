...
namespace TestProject1
{
    ...
    public class CERTIFICATION_RENEW_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[CERTIFICATION_RENEW_CodedStep] : Navigate to Completed Equipment Certification")]
        public void CERTIFICATION_RENEW_CodedStep()
        {
                // Navigate to : ''
        ...
        [CodedStep(@"[CERTIFICATION_RENEW_CodedStep1] : Navigate to Completed Technician Certification")]
        public void CERTIFICATION_RENEW_CodedStep1()
        {
                // Navigate to : ''
