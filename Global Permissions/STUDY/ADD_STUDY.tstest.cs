...
namespace TestProject1
{
    ...
    public class ADD_STUDY : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.AddStudyPage);
        }
        ...
        public void ADD_STUDY_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.AddStudyPage, true, 5000);
