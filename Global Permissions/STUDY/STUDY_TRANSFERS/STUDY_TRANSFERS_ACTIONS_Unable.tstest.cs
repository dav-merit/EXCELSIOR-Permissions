...
namespace TestProject1
{
    ...
    public class STUDY_TRANSFERS_ACTIONS_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[STUDY_TRANSFERS_ACTIONS_Unable_CodedStep] : Navigate to study transfers page")]
        public void STUDY_TRANSFERS_ACTIONS_Unable_CodedStep()
        {
            // Navigate to : ''
