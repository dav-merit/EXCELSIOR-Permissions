...
namespace TestProject1
{
    ...
    public class STUDY_TRANSFERS_DOWNLOAD_MANIFEST_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[STUDY_TRANSFERS_DOWNLOAD_MANIFEST_Unable_CodedStep] : Wait '5000' msec for Study Transfers landing page")]
        public void STUDY_TRANSFERS_DOWNLOAD_MANIFEST_Unable_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.StudyTransfersPage, true, 5000);
