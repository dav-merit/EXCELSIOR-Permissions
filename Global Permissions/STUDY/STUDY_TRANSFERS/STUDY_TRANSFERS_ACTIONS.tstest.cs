...
namespace TestProject1
{
    ...
    public class STUDY_TRANSFERS_ACTIONS : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.StudyTransfersPage);
        ...
        public void STUDY_TRANSFERS_ACTIONS_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.StudyTransfersPage, true);
            
        }
    
    
        [CodedStep(@"Enter text '' in 'StudyPasswordInput'")]
        public void STUDY_TRANSFERS_ACTIONS_CodedStep1()
        {
            // Enter text '' in 'StudyPasswordInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.StudyPasswordInput, Global_Variables.PermissionsPassword);
