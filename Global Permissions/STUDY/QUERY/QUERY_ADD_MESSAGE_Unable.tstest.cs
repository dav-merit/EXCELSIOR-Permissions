...
namespace TestProject1
{
    ...
    public class QUERY_ADD_MESSAGE_Unable : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.CertificationwithQuery);
        }
        ...
        public void QUERY_ADD_MESSAGE_Unable_CodedStep()
        {
            // Navigate to : ''
        ...
        [CodedStep(@"Navigate to : ''")]
        public void QUERY_ADD_MESSAGE_Unable_CodedStep1()
        {
            // Navigate to : ''
