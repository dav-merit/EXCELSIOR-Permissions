...
namespace TestProject1
{
    ...
    public class DOCUMENTS_VIEW_Unable2 : BaseWebAiiTest
    {
        ...
        public void Permissions_Template_CodedStep()
        {
            ...
            Log.WriteLine(Global_Variables.AssignedDocumentName);
        }
        ...
        public void DOCUMENTS_VIEW_Unable_CodedStep2()
        {
            // Enter text 'Test' in 'StudySearchInput'
            Actions.SetText(Pages.ExcelsiorStudy1Sandbox10.StudySearchInput, Global_Variables.AssignedDocumentName);
