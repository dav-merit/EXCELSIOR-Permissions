...
namespace TestProject1
{
    ...
    public class DOCUMENTS_VIEW_VERSIONS_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[DOCUMENTS_VIEW_VERSIONS_Unable_CodedStep] : Navigate to Document")]
        public void DOCUMENTS_VIEW_VERSIONS_Unable_CodedStep()
        {
            // Navigate to : ''
            ActiveBrowser.NavigateTo(Global_Variables.Document, true);
