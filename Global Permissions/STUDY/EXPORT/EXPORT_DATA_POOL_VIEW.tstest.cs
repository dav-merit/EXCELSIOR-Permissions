...
namespace TestProject1
{
    ...
    public class EXPORT_DATA_POOL_VIEW : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text 'Test' in 'ExportPasswordInput'")]
        public void EXPORT_DATA_POOL_VIEW_CodedStep()
        {
            // Enter text 'Test' in 'ExportPasswordInput'
            Actions.SetText(Pages.ExcelsiorStudy1Sandbox9.ExportPasswordInput, Global_Variables.PermissionsPassword);
            
        }
    
        [CodedStep(@"Wait '5000' msec for url:''")]
        public void EXPORT_DATA_POOL_VIEW_CodedStep1()
        {
