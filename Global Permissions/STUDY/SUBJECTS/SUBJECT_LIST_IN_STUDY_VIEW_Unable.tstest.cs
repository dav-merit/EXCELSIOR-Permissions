...
namespace TestProject1
{
    ...
    public class SUBJECT_LIST_IN_STUDY_VIEW_Unable : BaseWebAiiTest
    {
        ...
        public void SUBJECT_LIST_IN_STUDY_VIEW_CodedStep()
        {
                        // Wait '5000' msec for url:''
                        ActiveBrowser.WaitForUrl(Global_Variables.StudySubjectLandingPage, true, 5000);
