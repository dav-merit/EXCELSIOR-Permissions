...
namespace TestProject1
{
    ...
    public class STUDY_JOBS_DISMISS_ALL_Unable : BaseWebAiiTest
    {
        ...
        [CodedStep(@"Enter text '' in 'StudyPasswordInput'")]
        public void STUDY_JOBS_DISMISS_ALL_Unable_CodedStep1()
        {
            // Enter text '' in 'StudyPasswordInput'
            Actions.SetText(Pages.ExcelsiorStudyManagement0.StudyPasswordInput, Global_Variables.Password);
                        
        }
    
        [CodedStep(@"[STUDY_JOBS_VIEW_CodedStep] : Wait '5000' msec for Study Jobs landing page")]
        public void STUDY_JOBS_DISMISS_ALL_Unable_CodedStep()
        {
            // Wait '5000' msec for url:''
            ActiveBrowser.WaitForUrl(Global_Variables.StudyJobs, true, 5000);
