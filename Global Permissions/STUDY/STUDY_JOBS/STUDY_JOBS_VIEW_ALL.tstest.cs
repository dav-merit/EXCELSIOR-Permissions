...
namespace TestProject1
{
    ...
    public class STUDY_JOBS_VIEW_ALL : BaseWebAiiTest
    {
        ...
        [CodedStep(@"[STUDY_JOBS_VIEW_ALL_CodedStep] : Wait '5000' msec for Study Jobs landing page")]
        public void STUDY_JOBS_VIEW_ALL_CodedStep()
        {
