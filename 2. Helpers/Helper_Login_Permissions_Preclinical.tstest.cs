...
namespace TestProject1
{
    ...
    public class Helper_Login_Permissions_Preclinical : BaseWebAiiTest
    {
        ...
        public void VariableTest_CodedStep1()
        {
            ...
            Actions.SetText(Pages.ExcelsiorLogin.Username, Global_Variables.PermissionsUsername);
        ...
        public void VariableTest_CodedStep2()
        {
            ...
            Actions.SetText(Pages.ExcelsiorLogin.PasswordLogin, Global_Variables.PermissionsPassword);
        ...
        public void LoginHelper_CodedStep()
        {
            ...
            ActiveBrowser.WaitForUrl(Global_Variables.PreclinicalHomepage, true, 5000);
