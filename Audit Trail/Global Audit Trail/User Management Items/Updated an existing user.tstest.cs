...
namespace TestProject1
{
    ...
    public class Updated_an_existing_user : BaseWebAiiTest
    {
        ...
        public void Created_a_new_user_CodedStep()
        {
            // Enter text '' in 'PasswordInput'
            Actions.SetText(Pages.ExcelsiorGlobalManagement10.PasswordInput, Global_Variables.Password);
